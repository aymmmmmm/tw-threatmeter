...
### 全屏发光
仇恨超过 OT 阈值时屏幕边缘红色发光警告。<br>
坦克模式下自动禁用。<br>
<br>

### OT 警告声音
仇恨达到 OT 阈值时播放警告音效。<br>
坦克模式下自动禁用。<br>
<br>
...
### 坦克模式
显示一个额外窗口，列出你正在拉住的怪物，以及仇恨列表中下一个玩家的名字和仇恨百分比，方便快速换目标（此模式会禁用全屏发光和 OT 警告声音）。<br><br>
![tankmode](https://imgur.com/3eR28Zp.png)
<br>

### 标签行
显示或隐藏仇恨条上方的 Name/TPS/Threat/% Max 标签行。
<br>
